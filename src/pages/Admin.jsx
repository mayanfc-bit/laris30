  ...
  return (
    <div className="flex min-h-dvh items-center justify-center px-6">
      <form onSubmit={submit} className="w-full max-w-sm animate-fade-in space-y-4 text-center">
        ...
        <h1 className="font-display text-3xl">Painel da aniversariante</h1>
        <p className="text-sm text-petroleum/60">Só a Larissa passa daqui. 👑</p>
        <input
          type="password"
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 px-4 py-6">
      ...
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="font-display text-4xl">Painel da aniversariante</h1>
          <p className="text-sm text-petroleum/60">Tudo que rolou na Missão 30.</p>
        </div>
...
function Kpi({ icon: Icon, value, label }) {
  return (
    <div className="card text-center">
      ...
      <p className="mt-1 font-display text-4xl text-petroleum">{value}</p>
